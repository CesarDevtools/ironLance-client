...
function Sidebar() {
  ...
  return (
    <Stack style={{ top: 20 }}>
      <Paper withBorder p="lg" radius="md" shadow="sm">
        {!isLoggedIn ? (
          <Stack align="center" ta="center" py="md">
            ...
            <Button fullWidth component={Link} to="/signup" mt="md" radius="md">
              Get Started
            </Button>
          </Stack>
          ...
          <Stack align="center" ta="center">
            ...
            <Box>
              <Text fw={700} size="lg">
                Hello, {user.firstName || "Ironhacker"}!
              </Text>
              <Text size="xs" c="dimmed">
                {user.bootcamp || "Student"}
              </Text>
            </Box>
            <Divider w="100%" />
            <Box w="100%">
          ...
          <Stack align="center" ta="center">
            ...
            <Divider w="100%" />
            <Button fullWidth component={Link} to="/profile" size="xs">
              Profile
            </Button>
            <Button
              fullWidth
      ...
      >
        <Text size="xs" c="blue" fw={700} ta="center">
          Tip: Use skills in search to find specific roles!
        </Text>
      </Paper>
